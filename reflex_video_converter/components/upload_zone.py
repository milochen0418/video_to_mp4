...
def settings_panel() -> rx.Component:
    return rx.el.div(
        ...
        class_name="bg-gray-50/50 rounded-xl p-4 border border-gray-100 mb-6",
    )
        ...
        rx.el.div(
            rx.el.div(
                rx.el.div(
                    ...
                    rx.el.p(
                        "Convert AVI, MOV, MKV, WMV to MP4",
            ...
            rx.el.div(
                rx.upload.root(
                    ...
                    padding="0px",
                    accept={
                        "video/*": [".avi", ".mov", ".mkv", ".wmv", ".mp4", ".webm"]
                    },
                    multiple=True,
                    class_name="w-full",
                ),
